...
/**
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="Acme\BaseBundle\Repository\ProductoRepository")
...
//    }
     ...
     * Set type
     *
     * @param Acme\BaseBundle\Entity\AttributeCollection $type
     */
    public function setType(\Acme\BaseBundle\Entity\AttributeCollection $type)
    {
        $this->type = $type;
    }
     ...
     * Get type
     *
     * @return Acme\BaseBundle\Entity\AttributeCollection 
     */
